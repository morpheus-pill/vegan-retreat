    ...
    <main className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Registration</h1>
          <p className="text-xl text-gray-600">Join us for Vegan Retreat 2026</p>
        </div>
      </header>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-green-800">
                  Thank you for registering! We'll be in touch soon with more details about the venue and next steps.
                  For any immediate questions, feel free to DM us on Instagram{' '}
                  <a href="https://instagram.com/indic.pilgrim" target="_blank" className="underline font-medium">
                    @indic.pilgrim
                  </a>
                </p>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-red-800">
                  There was an error submitting your registration. Please try again or contact us directly on Instagram{' '}
                  <a href="https://instagram.com/indic.pilgrim" target="_blank" className="underline font-medium">
                    @indic.pilgrim
                  </a>
                </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="mobile" className="block text-lg font-medium mb-3">
          ...
          <section className="space-y-8 pt-12 border-t border-gray-200">
            ...
            <div className="space-y-6">
              <div>
                <label htmlFor="veganStatus" className="block text-lg font-medium mb-3">
                ...
                >
                  ...
                  <option value="exploring">Neither (exploring veganism)</option>
                </select>
              </div>

              <div>
                <label htmlFor="numberOfPeople" className="block text-lg font-medium mb-3">
                  How many people are you bringing? <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  id="numberOfPeople"
                  ...
                  className="w-full px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-lg"
                />
                <p className="text-sm text-gray-500 mt-2">Including yourself. Please specify number of adults and children if applicable.</p>
              </div>
          ...
          <section className="space-y-8 pt-12 border-t border-gray-200">
            <div>
              <h2 className="text-3xl font-bold mb-2">Experience & Engagement</h2>
              <p className="text-gray-600">Share your hopes and contributions</p>
            </div>

            <div className="space-y-6">
              <div>
                <label htmlFor="expectations" className="block text-lg font-medium mb-3">
              ...
              <div>
                <label htmlFor="activities" className="block text-lg font-medium mb-3">
                ...
                <textarea
                  ...
                  className="w-full px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-lg"
                />
                <p className="text-sm text-gray-500 mt-2">We'd love to know if you have skills or activities you'd like to share with the group</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-8 pt-12 border-t border-gray-200">
            <div>
              <h2 className="text-3xl font-bold mb-2">Help Us Spread the Word</h2>
              <p className="text-gray-600">Connect us with the vegan community</p>
            </div>

            <div className="space-y-6">
              <div>
                <label htmlFor="communityConnections" className="block text-lg font-medium mb-3">
                ...
                <textarea
                  ...
                  className="w-full px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-lg"
                />
                <p className="text-sm text-gray-500 mt-2">Where we could share about this event to find more vegans</p>
              </div>

              <div>
                <label htmlFor="referral" className="block text-lg font-medium mb-3">
                  Anyone you'd like us to share information about the retreat with?
                </label>
                <input
                  type="text"
                  id="referral"
          ...
          <section className="space-y-8 pt-12 border-t border-gray-200">
            <div>
              ...
              <p className="text-gray-600">Help us ensure your comfort and safety</p>
            </div>

            <div className="space-y-6">
              <div>
                <label htmlFor="dietaryInfo" className="block text-lg font-medium mb-3">
                ...
                <textarea
                  ...
                  className="w-full px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-lg"
                />
                <p className="text-sm text-gray-500 mt-2">This information is confidential and helps us ensure your safety and comfort</p>
              </div>

              <div>
                <label htmlFor="accessibilityRequirements" className="block text-lg font-medium mb-3">
          ...
          <section className="space-y-8 pt-12 border-t border-gray-200">
            <div>
              <h2 className="text-3xl font-bold mb-2">Consent & Acknowledgment</h2>
              <p className="text-gray-600">Please review and agree to the following</p>
            </div>
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-4 cursor-pointer group">
                ...
                <span className="text-lg group-hover:text-gray-700">
                  I will remain vegan throughout the entire retreat (both at the venue and outside) <span className="text-red-500">*</span>
                </span>
              </label>
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                ...
                />
                <span className="text-lg group-hover:text-gray-700">
                  I understand this is a self-organized, non-commercial retreat and expectations should be adjusted accordingly <span className="text-red-500">*</span>
                </span>
              </label>
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                ...
                />
                <span className="text-lg group-hover:text-gray-700">
                  I agree to abide by all retreat guidelines (no alcohol, smoking, or substances; civil and courteous behavior) <span className="text-red-500">*</span>
                </span>
              </label>
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                ...
                />
                <span className="text-lg group-hover:text-gray-700">
                  I have read and accept the cancellation and refund policy <span className="text-red-500">*</span>
                </span>
              </label>
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                ...
                />
                <span className="text-lg group-hover:text-gray-700">
                  I understand that organizer decisions are final and binding <span className="text-red-500">*</span>
                </span>
              </label>
              ...
              <div className="pt-4 border-t border-gray-200 mt-8">
                <label className="flex items-start gap-4 cursor-pointer group">
                  ...
                  />
                  <span className="text-lg group-hover:text-gray-700">
                    I'd like to receive updates about future vegan retreats and events
                  </span>
                </label>
              </div>
            </div>
